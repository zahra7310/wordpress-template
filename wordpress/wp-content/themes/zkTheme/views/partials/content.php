<section class="banner_main">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="ban_img">
                    <figure><img src=<?php Asset::images('ban_img.png') ?> alt="#" /></figure>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx yellow_bg">
                    <i><img src=<?php Asset::images('shoes.png') ?> alt="#" /></i>
                    <span>Shoes</span>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx bluedark_bg">
                    <i><img src=<?php Asset::images('underwear.png') ?> alt="#" /></i>
                    <span>underwear</span>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx yellow_bg">
                    <i><img src=<?php Asset::images('pent.png') ?> alt="#" /></i>
                    <span>Pante & socks</span>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx bluedark_bg">
                    <i><img src=<?php Asset::images('t_shart.png') ?> alt="#" /></i>
                    <span>T-shirt & tankstop</span>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx yellow_bg">
                    <i><img src=<?php Asset::images('jakit.png') ?> alt="#" /></i>
                    <span>cardigans & jumpers</span>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 pa_left">
                <div class="six_probpx bluedark_bg">
                    <i><img src=<?php Asset::images('helbet.png') ?> alt="#" /></i>
                    <span>Top & hat</span>
                </div>
            </div>
        </div>
